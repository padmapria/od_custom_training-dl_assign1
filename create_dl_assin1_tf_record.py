...
flags.DEFINE_string('label_map_path', 'dl_assignment1_label_map.pbtxt',
...
def main(_):
    ...
    logging.info('Reading from dl assign1 dataset.')
    ...
    train_output_path = os.path.join(FLAGS.output_dir, 'dl_assignment1_train.record')
    val_output_path = os.path.join(FLAGS.output_dir, 'dl_assignment1_val.record')
